# <img style="float: right; width: 25%" src="Threats.png"/>Quick-Start: Threats
...
We provide a simple [Quick-start Threat Registry](../smart/ThreatRegister.xlsx); it's just a list as above. See also an [explanation video](https://www.youtube.com/watch?v=9Zwl-BxyUQg&list=PLKjQAPJ7DIEpwAtzMKIRAiOrNvuk4qjWb&index=3&t=63s).

---

[Back to Playbook](./Playbook.md)  ●  [Home Example](examples/Home.md#Threats)  ●  [Next: Quick-Start Security Picture](./SecurityPicture.md)  ●  [Smarter Threat Assessments](../smart/Threats.md)
