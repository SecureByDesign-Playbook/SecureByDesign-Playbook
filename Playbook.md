...
* To be clear about **what you are assessing**. In the software world, we are typically developing a system to be used by someone else. We need therefore to assess the risks the *deployed* system has, and also the risks to the *development team*. These are two different assessments.
...
* **Threat assessments**. We provide a starter spreadsheet for you to use, but you will probably need to tailor it and add to it for your own specific situation.
...
<img style="float: right; width: 25%" src="./assess/Threat - Burglar.png"/>Adversaries have a range of capabilities and motivations, both generally and when applied to our specific space and assets. 
...
<img style="float: right; width: 25%" src="./Presentation.png"/>Your action plan needs to go to your business team who will be approving the financial spend. You now have both the costs and the risks, so all the information is here that they need.
